...
\begin{itemize}
	...
	\item \textbf{ProcRow5} - The initial implementation of \textit{Processing by row sections} where each section comprised of 512 rows with $ tol = 0.005 $.
...
Note that the tolerance value $ tol $ was set to 0.001 for the \textit{Base} optimization and 0.005 for the \textit{SM}, and \textit{SM opt.}.
...
\begin{figure}[ht!]
	...
	\begin{tikzpicture}
		\begin{axis}
			...
			\legend{Base, SM, SM opt., ProcRow5, ProcRow0, ParSecGPU, ICM32}
		\end{axis}
	\end{tikzpicture}
...
\begin{table}[ht!]
	...
	\begin{tabular}{ |c|c|c|c|c|c|c|c| } 
		\hline
		Optimization & Base    & SM     & SM opt. & ProcRow5 & ProcRow0 & ParSecGPU & ICM32 \\
		\hline
