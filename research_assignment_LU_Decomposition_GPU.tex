...
\usepackage{nicematrix, tikz}	 % Visual representation of matrices, graphs etc. - 'nicematrix' is experimental
\usetikzlibrary{plotmarks, positioning, fit}
\usetikzlibrary{decorations.pathreplacing, matrix, calc, shapes.arrows}
...
\addbibresource{bibliography.bib}				 		  % Specify path to bibliography file
...
\setlength{\emergencystretch}{17.5pt} % Allow compiler to create more spaces between words to avoid overflow of text
...
\includepdf[pages={1}]{resources/vyz-zadani-cejka.pdf}
...
\include{ch3_comparing-decomposition-implementations}
